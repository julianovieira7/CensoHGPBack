...
public class Dbinit implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario usuario1 = new Usuario("230995", "Gabrielle Pereira Rocha", "iury@gmail.com",pe.encode("123456"), true);
        usuario1.addPerfil(Perfil.Enfermeiro);
        listaUsuarios.add(usuario1);

        Usuario usuario2 = new Usuario("2309952", "Brenda Martins Dias", "felipe@gmail.com",pe.encode("123456"), true);
